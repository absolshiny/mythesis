...
void movfuzzycator(float teta, float pf)
{
  ...
  //----------------------------------------
  float uvn = trap(pf,-30,0,5,8); //Very Near
  float une = trap(pf,5,7,30,33); // Near
  ...
  //----------------------------------------
//  float uonc = trap(sc,0.1,2,7,20); // objective near centre
//  float uofc = trap(sc,17,20,300,400); // objective near centre
//  //----------------------------------------  
//  // valores de pertenencia del sensor derecho
//  //----------------------------------------
//  float uspd = trap (sd,0.1,2,9,15);// objective near en sensor derecho
//  //----------------------------------------  
//  // valores de pertenencia del sensor izquierdo
//  //----------------------------------------
//  float uspi = trap (si,0.1,2,10,20);// objective near en sensor izquierdo
//  //------------------------------------------
